    ...
    <body>
        ...
        <header>
            ...
            <div id="wrapper" >
                ...
                <div id="leftcontent">
                    <center>
                        <h1><u>Insert Kamar</u></h1>
                        <form action="Launcher" method="POST">
                            <table>
                                ...
                                <tr>
                                    <td>Kode Kamar</td>
                                    <td>:</td>
                                    <td><input type="text" name="kode_kamar"  /></td>
                                </tr>
                                <tr>
                                    <td>Nama Kamar</td>
                                    <td>:</td>
                                ...
                                <tr>
                                    <td>Lantai Kamar</td>
                                    <td>:</td>
                                    <td><input type="text" name="lantai_kamar" /> </td>
                                </tr>
                                <tr>
                                    <td>Tipe Kamar</td>
                                    <td>:</td>
                                ...
                                <tr>
                                    <td></td>
                                    <td></td>
                                    <td align="right"><input type="submit" value="Insert" name="tombol"/></td>
                                </tr>
                            </table>
                        </form>

                        <h1><u>Data Rooms</u></h1>
                            ...
                            <tbody>
                                    ...
                                    <tr>
                                        <%
                                            ...
                                            {
                                                out.println("<tr>");
                                                out.println("<td style='color:#0000A0;'>" + kmr.getId()
                                                + "</td><td style='color:#0000A0;'>" + kmr.getKode_kamar()
                                                + "</td><td style='color:#0000A0;'>" + kmr.getNama_kamar()
                                                + "</td><td style='color:#0000A0;'>" + kmr.getLantai_kamar()
                                                + "</td><td style='color:#0000A0;'>" + kmr.getTipe_kamar()
                                                + "<td style='color:#0000A0;'>" + kmr.getHarga() + "</td>");
                                                out.println("<td><a href=proses_delete?id="+kmr.getId()+" class=btn btn-info btn-sm>Delete</a></td>");
                                                out.println("<td><a href=Update.jsp?id="+kmr.getId()+" class=btn btn-info btn-sm>Update</a></td>");
                                                out.println("</tr>");
                                            }
                                        %>
                                    </tr>
